...
package com.smartstudy.uskid.library.share.core.handler.qq;
 ...
 * @since 2015/10/8
 */
public abstract class BaseQQHandler extends BaseHandler {

    private static String mAppId;
    protected static Tencent mTencent;

    public BaseQQHandler(Activity context, BiliShareConfiguration configuration) {
    ...
    protected final IUiListener mUiListener = new IUiListener() {
        ...
        public void onComplete(Object response) {
            if (getShareListener() != null) {
                getShareListener().onSuccess(getShareMedia(), BiliShareStatusCode.ST_CODE_SUCCESSED,new Result());
            }
        }
