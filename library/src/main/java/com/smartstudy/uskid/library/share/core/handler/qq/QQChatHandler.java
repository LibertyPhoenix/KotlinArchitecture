 ...
 * @since 2015/10/8
 */
public class QQChatHandler extends BaseQQHandler {

    public QQChatHandler(Activity context, BiliShareConfiguration configuration) {
    ...
    private void shareImage(BaseShareParam params, final ShareImage image) throws ShareException {
        mImageHelper.downloadImageIfNeed(image, (Runnable) () -> {
            final Bundle bundle = new Bundle();
