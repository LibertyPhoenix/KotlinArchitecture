...
package com.smartstudy.uskid.library.share.core.handler.generic;
...
import com.smartstudy.uskid.library.share.util.BuildHelper;
...
public class CopyHandler extends BaseHandler {
    ...
    public CopyHandler(Activity context, BiliShareConfiguration configuration) {
    ...
    private void share(BaseShareParam param) {
        ...
        String content = param.getContent()+ " "+param.getTargetUrl();
