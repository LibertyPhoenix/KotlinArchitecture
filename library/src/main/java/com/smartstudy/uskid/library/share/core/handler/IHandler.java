...
import com.smartstudy.uskid.library.share.core.IActivityLifecycleMirror;
...
public interface IHandler extends IActivityLifecycleMirror {
    ...
    void share(BaseShareParam params, SocializeListeners.ShareListener listener) throws Exception;//分享

    void login(SocializeListeners.ShareListener listener) throws Exception;
