...
import com.smartstudy.uskid.library.share.core.Share;
...
import com.smartstudy.uskid.library.share.util.SharePlatformConfigHelper;
        ...
        //implements IWeiboHandler.Response
{
    ...
    private SinaHandler mShareHandler;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //解决多进程问题
        BiliShareConfiguration shareConfig = Share.getShareConfiguration();
        if (shareConfig == null) {
        ...
        mShareHandler = new SinaHandler(this, shareConfig);
        try {
...
//
//        if (SinaHandler.mWeiboShareAPI != null &&
//                SinaHandler.mWeiboShareAPI.isWeiboAppInstalled() &&
